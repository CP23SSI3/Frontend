  ...
  <table class="min-w-full divide-y divide-gray-400">
    ...
    <tbody class="divide-y divide-gray-400">
      ...
      <tr class="divide-x divide-gray-400">
        ...
        <td class="p-4 text-gray-500 tex t-sm">
      ...
      <tr class="divide-x divide-gray-400">
        ...
        <td class="p-4 text-sm text-gray-500">
          <BaseProfile fname="vichuta" lname="pipopinyo" /> vichuta pipopinyo
          <BaseProfile fname="Piraya" lname="xxxx" /> Piraya xxxx
          <BaseProfile fname="User" lname="name" /> User name
        </td>
      </tr>
      <br />
      <br />
