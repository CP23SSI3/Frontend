        ...
        <div class="fixed inset-0 flex">
          ...
          >
            <DialogPanel class="relative flex flex-1 w-full max-w-xs mr-16">
              ...
              <div
                class="flex flex-col px-6 pb-4 overflow-y-auto bg-indigo-600 grow gap-y-5"
              >
                ...
                <nav class="flex flex-col flex-1">
                  <ul role="list" class="flex flex-col flex-1 gap-y-7">
                    ...
                    <li class="mt-auto">
                      <a
                        href="#"
                        class="flex p-2 -mx-2 text-sm font-semibold leading-6 text-indigo-200 rounded-md group gap-x-3 hover:bg-indigo-700 hover:text-white"
                      >
                        <Cog6ToothIcon
