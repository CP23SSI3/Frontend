<template>
  ...
  <div class="container mx-auto">
    <div class="grid w-auto gap-6 px-4 sm:grid-cols-6 lg:grid-cols-12">
      <div class="sm:col-span-2 lg:col-span-3">
        <div class="p-6 bg-white rounded-lg shadow">
          ...
          <div class="flex flex-col">
            <span class="mb-2 font-bold tracking-wider text-gray-700 uppercase"
              >Skills</span
            >
            <ul>
      ...
      <div class="sm:col-span-4 lg:col-span-9">
        <div class="p-6 bg-white rounded-lg shadow">
          ...
          <h3 class="mt-3 -mb-2 font-semibold text-center">Find me on</h3>
